...
VL53L0X Sensor1;  //6 oclock
VL53L0X Sensor2;  // upward
VL53L0X Sensor3;  // 9 oclock
VL53L0X Sensor4;  //noon
VL53L0X Sensor5;  // 3 oclock
...
void loop() {
  ...
  //command_heartbeat();
  command_distance_1(); //6ock
  command_distance_2(); //up
  command_distance_3(); //9ock
  command_distance_4();  //12ock
  command_distance_5(); //3ock
